...
//! (buffer 0x21 0xFF 0x56 0x78 0x7F 0x99 0x65 0x45)
//! (buffer 0xAA 0xBB 0xCC 0xDD 0xEE 0xFF)

//! (buffer 0x54 0x65 0x73 0x74 0x00)
//          Translates to "Test", with the implicit '\0' added
//! (buffer)
//! (buffer 0xAA 0xBB 0xCC 0xDD 0xEE 0xFF 0x12 0x34)
//! (buffer 0x86 0x43 0x89 0x56 0x06 0x34 0x28 0x83 0x90)
